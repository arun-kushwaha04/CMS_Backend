...
<head>
    ...
    <title>Reset Your Apna Classroom Password</title>
    <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #b582c2; height: 100%; margin: 0; padding: 0; width: 100%">
    <center>
 ...
 100%; background-color: #b582c2; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
            <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;height: 20px;
 font-weight: normal; text-decoration: none;display: flex;">
                                                                    <img align="none" alt="Apna Classroom" height="32"
                                                                        src="http://www.inetmyanmar.com/wp-content/uploads/2020/07/googleclassromtutorialimage-180x138.png"
                                                                        style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 90px; height: 69px; margin: 0px;"/>
 <strong  style="font-size: 30px;text-align: right;margin: auto;">Apna Classroom</strong>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                                <span class="" style="mso-line-height-rule:
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                                <a class="mcnButton " href="<RESET_LINK>" style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;cursor: pointer;
 " target="_blank"
